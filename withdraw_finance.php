...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(intval($_SESSION['EUR']) < intval($input_eur))
    {
        $EUR = 0;
        $eur_err = "Not enough money.";
    }
    ...
    if(intval($_SESSION['USD']) < intval($input_usd))
    {
        $USD = 0;
        $usd_err = "Not enough money.";
    }
    ...
    if(intval($_SESSION['GBP']) < intval($input_gbp))
    {

        $GBP = 0;
        $gbp_err = "Not enough money.";
    }
...
if(empty($usd_err) || empty($eur_err) || empty($gbp_err)){
    ...
    if($stmt = $mysqli->prepare($sql)){
        ...
        $param_eur = strval(intval($_SESSION['EUR'] - intval($EUR)));
        $param_usd = strval(intval($_SESSION['USD'] - intval($USD)));
        $param_gbp = strval(intval($_SESSION['GBP'] - intval($GBP)));
...
<head>
    ...
    <meta charset="UTF-8">
    <title>Withdraw Finance Page</title>
...
<div class="col-md-11 d-flex">
    ...
    <h2> &nbsp; &nbsp; &nbsp; &nbsp; How much do you want to withdraw from wallet? &nbsp; &nbsp;</h2>
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    ...
                    <input type="submit" class="btn btn-primary" value="Withdraw money securely" data-buttonText="Your label here."/>
